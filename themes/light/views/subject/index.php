<form action="" class="jNice">
						...
						<table cellpadding="0" cellspacing="0">
							<tr>
								...
								<td class="action"><a href="#" class="view">View</a><a
									href="#" class="edit">Edit</a><a href="#" class="delete">Delete</a>
								</td>
							</tr>
							<tr class="odd">
						...
						<fieldset>
							...
							<p>
								<label>Sample label:</label><input type="text"
									class="text-medium" /><input type="text" class="text-small" /><input
									type="text" class="text-small" />
							</p>
							<p>
								<label>Sample label:</label> <select>
